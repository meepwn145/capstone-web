...
function AdminPage() {
  ...
  <p><img src="paint.png" alt="Parking Seeker Icon" className="icon" /><a href ='FetchEstablishments' style={{ color: 'white', textDecoration: 'none' }}> Establishment List</a></p>
  ...
  <p><img src="agent.png" alt="Parking Seeker Icon" className="icon" /><a href ='FetchAgents' style={{ color: 'white', textDecoration: 'none' }}> Agents List</a></p>
